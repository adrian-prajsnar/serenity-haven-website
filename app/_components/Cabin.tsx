...
export default function Cabin({ cabin }: CabinProps) {
  ...
  return (
    <div className='grid grid-cols-[3fr_4fr] gap-20 border border-primary-400 py-3 px-10 mb-24'>
      ...
      <div>
        <h3 className='text-accent-700 font-semibold text-7xl mb-5 translate-x-[-254px] bg-primary-50 p-6 pb-1 w-[150%]'>
          Cabin {name}
        </h3>
